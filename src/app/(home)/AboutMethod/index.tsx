...
const AboutMethod = () => {
  return (
    <section
      ...
      className="about-method 3xl:p-[1.667vw] 3xl:rounded-[2.083vw] bg-gradient-about invisible absolute top-0 left-0 z-20 flex min-h-svh w-full flex-col rounded-[1.25rem] bg-slate-950 p-4 md:rounded-[2.5rem] md:p-8"
    >
