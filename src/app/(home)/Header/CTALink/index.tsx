...
const CTALink = ({ className = '', ...props }: CTAButtonProps) => {
  return (
    <Link
      ...
      className={`3xl:text-[1.46vw] 3xl:py-[.625vw] 3xl:px-[1.25vw] transition-default rounded-full bg-slate-300/75 px-6 py-3 text-[clamp(1rem,3vw,1.25rem)] font-medium text-slate-950 hover:bg-slate-300/90 active:scale-90 active:bg-slate-300 ${className}`}
      {...props}
    />
  );
};
